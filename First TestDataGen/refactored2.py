...
class TestDataGen(Frame):
    ...
    def AddRow(self):
        ...
        self.master.Max.grid(column = 4, row = self.master.grid_size()[1], pady = 3, padx = 3, sticky = 'EW')
        self.master.Max.configure(takefocus = 0)
        #self.master.Max.set(4)
          
        self.master.Min = Entry(self.master, width = 7)
        self.master.Min.grid(column = 3, row = self.master.grid_size()[1] - 1, pady = 3, padx = 3, sticky = 'EW')
        ...
        self.master.dropDownCatAdd.grid(column = 1, row =self.master.grid_size()[1] - 1, pady = 3, padx = 3,sticky = "EW")
