...
class TestDataGen(Frame):
    ...
    def init_window(self):
        ...
        while c <= 4:
            ...
            self.master.dropDownCat = OptionMenu(self.master, self.master.cat1, '', *TestDataGen.categoriesList, command=self.func)
            ...
            self.master.fieldDD = OptionMenu(self.master, self.master.fieldDropDVar, '',  *TestDataGen.newMenuList)
    ...
    def func(self,value):
        ...
        if value == 'Personal':
            ...
            self.master.fieldDD = OptionMenu(self.master, self.master.fieldDropDVar, '',  *self.personalList)
        elif value == 'Geographic':
            self.master.fieldDD = OptionMenu(self.master, self.master.fieldDropDVar, '',  *self.geographicList)
        elif value == 'Date':
            self.master.fieldDD = OptionMenu(self.master, self.master.fieldDropDVar, '',  *self.dateList)
        else:
            self.master.fieldDD = OptionMenu(self.master, self.master.fieldDropDVar, '',  *self.newmenuList)
        ...
        self.master.fieldDD.grid(column = 2,row = self.master.grid_size()[1]-5,  pady = 5, padx = 5)
