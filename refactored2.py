...
class TestDataGen(Frame):
    ...
    def DeleteRows(self):
        ...
        if TestDataGen.deleteButtonWidgList[i] == TestDataGen.rowList(self.master.destroyRowButtonAdd.grid_info()['row']):
                #print(self.master.destroyRowButton.grid_info()['row'])
             #   rowNumber = self.master.destroyRowButton.grid_info()['row']
              #  TestDataGen.deleteButtonWidgList[rowNumber].destroy()            
               # TestDataGen.dropDownCatWidgList[rowNumber].destroy()
